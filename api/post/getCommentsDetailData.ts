...
export const commentsDetail: CommentData[] = [
  {
    success: true,
    code: 200,
    postId: 1,
    data: [
      ...
      },
      {
        ...
        commentContent: '이거 보고 저도 해보고 싶어졌어요.',
        likeCount: 7,
      },
      {
        commentId: 5,
      ...
      },
      {
        ...
        commentContent: '다음에는 어떤 디자인 하실 건가요?',
        likeCount: 2,
      },
      {
        commentId: 8,
