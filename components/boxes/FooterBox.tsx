...
export default function FooterBox() {
  ...
  console.log(path)
  return (
    <div className={`${path === '/sign-up' && 'hidden'} relative w-full h-[30px] ${path !== '/sign-up' && 'xs:hidden sm:hidden md:block'} `}>

    <div
      className={`flex flex-wrap items-center justify-center w-full translate-y-[-10px] xs:h-[30px] xs:gap-[5px] sm:h-[30px] sm:gap-[10px] `}
    >
