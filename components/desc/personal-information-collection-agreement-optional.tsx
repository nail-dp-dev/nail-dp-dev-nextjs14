...
export default function PersonalInformationCollectionAgreementOptionalComponent({ isSmall }: { isSmall: boolean }) {
    ...
    <div className='w-full h-full flex flex-col'>
      <div className='w-full h-full flex flex-col transition-all gap-[24px]'>
        <div className='w-full h-[70px] flex items-center justify-start gap-[10px] border-b-[1px] border-darkGray'>
          { !isSmall && <NdpIcon />}
          <span className={`${isSmall ? 'text-[16px]' : 'text-[24px]'} font-[700] text-textDarkPurple`}>네디플 개인 정보 수집 동의서{`[선택]`}</span>
        </div>
        ...
        <div className='w-full flex-1 flex flex-col overflow-y-auto gap-[30px] px-[10px] pt-[20px] pb-[50px]'>
          <div className='spanDiv w-full min-h-[50px] flex flex-col flex-shrink-0'>
            <h2 className='font-[500] text-[18px]'>선택적 개인 정보 수집 항목</h2>
            <span className='font-[350] text-[14px]'>우리는 다음과 같은 개인 정보를 선택적으로 수집할 수 있습니다</span>
            <span className='font-[350] text-[14px]'><span className='font-[700] text-[14px]'>마케팅 정보:</span> <span className='font-[500] text-[14px]'>제품 및 서비스에 대한 프로모션, 할인, 뉴스레터 등을 포함한 마케팅 커뮤니케이션 수신에 대한 동의.</span></span>
            <span className='font-[350] text-[14px]'><span className='font-[700] text-[14px]'>사용자 선호도:</span> <span className='font-[500] text-[14px]'>귀하의 취향 및 선호도에 따라 맞춤형 서비스를 제공하기 위해 필요한 정보.</span></span>
          </div>

          <div className='spanDiv w-full min-h-[50px] flex flex-col flex-shrink-0'>
            <h3 className='font-[700] text-[16px]'>개인 정보 수집 목적</h3>
            <span className='font-[350] text-[14px]'>귀하의 개인 정보는 다음과 같은 목적으로 사용될 수 있습니다</span>
            <span className='font-[350] text-[14px]'> <span className='font-[500] text-[14px]'>-귀하의 관심사에 맞춘 마케팅 자료 및 프로모션 제공</span></span>
            <span className='font-[350] text-[14px]'> <span className='font-[500] text-[14px]'>-네디플의 서비스 개선 및 사용자 경험 향상</span></span>
          </div>
          <div className='spanDiv w-full min-h-[50px] flex flex-col flex-shrink-0'>
            <h3 className='font-[700] text-[16px]'>마케팅 커뮤니케이션 수신 동의</h3>
            <span className='font-[350] text-[14px]'>귀하는 <span className='font-[500] text-[14px]'>네디플로부터 마케팅 커뮤니케이션을 받는 것에 동의</span>합니다. 이를 통해 귀하는 <span className='font-[500] text-[14px]'>서비스 업데이트, 프로모션, 할인</span> 등의 정보를 받을 수 있습니다.  원하실 경우 언제든지 마케팅 커뮤니케이션 수신을 거부할 수 있습니다.</span>
          </div>
          <div className='spanDiv w-full min-h-[50px] flex flex-col flex-shrink-0'>
            <h3 className='font-[700] text-[16px]'>정보 공유 및 공개</h3>
            <span className='font-[350] text-[14px]'>귀하의 개인 정보를 제3자에게 판매하거나 임대하지 않습니다. 귀하의 정보는 다음과 같은 경우에만 공유됩니다</span>
            <span className='font-[350] text-[14px]'> -마케팅 서비스 제공업체와 <span className='font-[500] text-[14px]'>협력하여 프로모션 및 마케팅 활동을 진행할 때</span></span>
          </div>
          <div className='spanDiv w-full min-h-[50px] flex flex-col flex-shrink-0'>
            <h3 className='font-[700] text-[16px]'>정보 접근 및 관리 권한</h3>
          ...
          <div className='spanDiv w-full min-h-[50px] flex flex-col flex-shrink-0'>
            <h3 className='font-[700] text-[16px]'>정책 변경</h3>
          ...
          <div className='spanDiv w-full min-h-[50px] flex flex-col flex-shrink-0'>
            <h3 className='font-[700] text-[16px]'>연락처 정보</h3>
