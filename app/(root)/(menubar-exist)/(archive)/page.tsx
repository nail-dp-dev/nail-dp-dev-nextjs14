...
//       />
//       <div className="ForYouContainer relative h-dvh">
//         <div
//           ref={boxRef}
//           className="outBox relative flex h-full flex-wrap items-center gap-[0.7%] overflow-y-scroll transition-all"
//         >
//           {!likedButtonState &&
//             isContentExist &&
//             !isLoading &&
...
//                   className="absolute bottom-1 right-1 z-20 hidden w-full group-hover/button:border-purple md:block lg:bottom-2 lg:right-2"
//                 >
//                   <PlusButton
//                     postId={item.photoId}
//                     width={`${isPlus}px`}
//                     height={`${isPlus}px`}
//                     isClicked={item.saved}
