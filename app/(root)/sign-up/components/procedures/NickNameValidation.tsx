...
export default function NickNameValidation({ finalAgreement, finalPhoneNumber }: SignUpNickNameProps) {
  ...
  return (
    <div className='w-[350px] h-[400px] md:w-[440px] md:h-[450px] p-[20px] mt-[20px] md:mt-0 flex flex-col items-start justify-start bg-white rounded-[20px] shadow-signup-modal-shadow'>
      ...
      <div className='w-full md:w-[400px] h-[60px] pl-[15px] flex items-center justify-start border-purple border-[2px] rounded-[12px]'>
        <input
          className='w-[340px] md:w-[368px] h-[20px] text-[0.875rem] outline-none'
      ...
      <button
        className={`submitBtn w-full md:w-[400px] h-[60px]  button-layout ${nicknameError === '' && isNicknameAvailable ? 'button-tr button-tr-tf button-color' :'bg-buttonDarkGray'}`}
